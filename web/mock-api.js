    ...
    '/api/cdn-hit': () => ({
      ...
      probes: [
        { domain: 'www.taobao.com', label: '淘宝', provider: '阿里云', provider_id: 'alibaba',
          ecs_echoed: true, ecs_scope: 24, has_mainland: true, mainland_prefixes: 86, addrs: ['119.147.144.9'], prefix: '119.147.144.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.qq.com', label: '腾讯', provider: '腾讯云', provider_id: 'tencent',
          ecs_echoed: true, ecs_scope: 24, has_mainland: true, mainland_prefixes: 114, addrs: ['121.14.77.201'], prefix: '121.14.77.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.baidu.com', label: '百度', provider: '百度云', provider_id: 'baidu',
          ecs_echoed: true, ecs_scope: 24, has_mainland: true, mainland_prefixes: 35, addrs: ['110.242.68.66'], prefix: '110.242.68.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.apple.com', label: 'Apple', provider: 'Akamai', provider_id: 'akamai',
          ecs_echoed: true, ecs_scope: 24, has_mainland: true, mainland_prefixes: 0, addrs: ['23.55.36.15'], prefix: '23.55.36.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.microsoft.com', label: '微软', provider: 'Microsoft', provider_id: 'microsoft',
          has_mainland: true, mainland_prefixes: 5, addrs: ['104.85.113.15'], prefix: '104.85.0.0/16',
          ecs_echoed: false, ecs_scope: 0,
          verdict: 'stranded', verdict_text: 'ECS 未送达，权威只能按隧道出口调度' },
        { domain: 'd1.awsstatic.com', label: 'AWS 静态资源', provider: 'AWS', provider_id: 'amazon',
          has_mainland: true, mainland_prefixes: 35, addrs: ['13.225.117.71'], prefix: '13.224.0.0/14',
          ecs_echoed: true, ecs_scope: 24,
          verdict: 'no_node', verdict_text: 'ECS 已送达，权威仍给境外（该服务在大陆没有节点）' },
        { domain: 'www.cloudflare.com', label: 'Cloudflare', provider: 'Cloudflare', provider_id: 'cloudflare',
          has_mainland: false, mainland_prefixes: 1, addrs: ['104.16.132.229'], prefix: '104.16.0.0/13',
          ecs_echoed: true, ecs_scope: 0,
          verdict: 'thin', verdict_text: '境外节点（该 CDN 的大陆段太少，判据弃权）' },
      ],
    }),
