    ...
    '/api/cdn-hit': () => ({
      ...
      probes: [
        { domain: 'www.taobao.com', label: '淘宝', provider: '阿里云', provider_id: 'alibaba',
          has_mainland: true, mainland_prefixes: 86, addrs: ['119.147.144.9'], prefix: '119.147.144.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.qq.com', label: '腾讯', provider: '腾讯云', provider_id: 'tencent',
          has_mainland: true, mainland_prefixes: 114, addrs: ['121.14.77.201'], prefix: '121.14.77.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.baidu.com', label: '百度', provider: '百度云', provider_id: 'baidu',
          has_mainland: true, mainland_prefixes: 35, addrs: ['110.242.68.66'], prefix: '110.242.68.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.apple.com', label: 'Apple', provider: 'Akamai', provider_id: 'akamai',
          has_mainland: true, mainland_prefixes: 0, addrs: ['23.55.36.15'], prefix: '23.55.36.0/24',
          verdict: 'mainland', verdict_text: '命中大陆节点' },
        { domain: 'www.microsoft.com', label: '微软', provider: 'Microsoft', provider_id: 'microsoft',
          ...
          verdict: 'stranded', verdict_text: '该 CDN 有大陆节点，却拿到境外节点' },
