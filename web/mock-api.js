    ...
    '/api/cdn-hit': () => ({
      ...
      probes: [
        ...
        { domain: 'www.cloudflare.com', label: 'Cloudflare', provider: 'Cloudflare', provider_id: 'cloudflare',
          has_mainland: false, addrs: ['104.16.132.229'], prefix: '104.16.0.0/13',
          verdict: 'offshore', verdict_text: '境外节点（该 CDN 没有大陆段）' },
      ],
    }),
